<?php
# 定义命名空间
namespace Test\Adapter\Tencent\Auth;
use \Ebsdk\Adapter\Tencent\Auth as Auth;

# 包含信赖文件
$application_path = __DIR__ . '/../../../../application';
require_once $application_path . '/Adapter/Tencent/Auth/Oauth.php';
...
class Oauth extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateForConfig()
    {
        ...
        $this->assertInstanceOf('MBOpenToAuth', $auth->getDriver());
    }
